      ...
      <div className="flex flex-wrap -m-4">
        <div className="p-4 sm:p-8 w-full">
          <div className="h-full bg-gray-100 p-8 rounded">
            ...
            <p className="leading-relaxed mb-6 text-[#890809] font-canada h-[12rem] md:h-[7rem]">The Kitchen Arts delivers quality kitchens within budget and timeline. Their after-work service is excellent, and Kalpesh Kawa and team coordinate well, providing prompt solutions for on-site difficulties.</p>
            <a className="inline-flex items-center">
              <img alt="testimonial" src="https://dummyimage.com/106x106" className="w-12 h-12 rounded-full flex-shrink-0 object-cover object-center"/>
              <span className="flex-grow flex flex-col pl-4">
                <span className="title-font font-medium text-gray-900">Sharmila Vashist</span>
